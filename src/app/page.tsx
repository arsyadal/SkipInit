...
type Framework =
  | "nextjs" | "vite" | "astro" | "sveltekit" | "remix" | "hono" | "express" | "nestjs" | "fastify" | "solid" | "htmx" | "nuxt" | "angular" | "vue" | "deno"
  | "fastapi" | "django" | "flask"
  | "go" | "rust"
  | "laravel" | "symfony"
  | "springboot" | "quarkus" | "dotnet" | "blazor"
  | "rails"
  | "phoenix";
...
const FRAMEWORKS: FrameworkDef[] = [
  ...
  { id: "fastify",    label: "Fastify",       lang: "js",      logo: `<svg class="w-5 h-5" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M21.5 4.5L14 7l-1.5 2.5L10 10l-.5 1.5-2 .5L6 14l-3.5 1L2 17l3-.5-.5 1.5L7 17l6-1.5 1-2 2.5-1 .5-2 2.5-1 2-4.5z"/></svg>` },
  { id: "solid",      label: "SolidJS",       lang: "js",      logo: `<svg class="w-5 h-5" viewBox="0 0 24 24" fill="#2C4F7C" xmlns="http://www.w3.org/2000/svg"><path d="M12 3C7 3 3.5 5.5 2 7.5l5 1.5c1.5-1 3.5-1.5 5.5-1L20 6.5C18 4.5 15.5 3 12 3zM6.5 10.5L2 12.5c1.5 2 5 4.5 10 4.5 2 0 4-.5 5.5-1.5l-4.5-2c-2 .5-4.5 0-6.5-3zM12 18.5c-2 0-4-.5-5.5-1.5L4 19c2 1.5 5 2.5 8 2 3.5-.5 6.5-2.5 8-4.5l-4.5-1c-1 1.5-2.5 2.7-3.5 3z"/></svg>` },
  { id: "htmx",       label: "htmx",          lang: "js",      logo: `<svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="#3465A4" stroke-width="2" xmlns="http://www.w3.org/2000/svg"><path d="M8 4L3 12l5 8M16 4l5 8-5 8M13 4l-2 16"/></svg>` },
  ...
  { id: "quarkus",    label: "Quarkus",       lang: "java",    logo: `<svg class="w-5 h-5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M12 2l8.66 5v10L12 22l-8.66-5V7L12 2z" fill="none" stroke="#4695EB" stroke-width="1.5"/><path d="M12 7v10M7.7 9.5l8.6 5M16.3 9.5l-8.6 5" stroke="#FF004A" stroke-width="1.5"/></svg>` },
